...
**Next-up:** §A1 visual-direction reviewer commissions Slice 0 per T010 (the `/impeccable shape 008-receipt-surfaces` invocation drafts the renderer-portion of the shape brief; the reviewer authors the printed-slip portion). T011 records the combined sign-off; §A1 clears. Slice 1 then becomes startable conditional on §A3 + §A4 also clearing.
...
| Slice 0 visual direction | ⏳ Held — see §A1 row |
...
## §A1 sign-off (T011 — pending)

*This section is empty until T011 fires. Format will follow 006's S0 sign-off pattern:*
...
> **Date:** YYYY-MM-DD
> **Reviewer:** Ahmed
> **Result:** approved | approved-with-revisions
> **`visual-direction/README.md` sign-off SHA:** <commit>
> **`/impeccable shape=pass` recorded:** YYYY-MM-DD (same event as the §A1 sign-off per preflight §3)
> **Sub-items covered (T010 (a–g)):** [ ] (a) first_print printed slip · [ ] (b) reprint_duplicate with bilingual duplicate-copy marker · [ ] (c) preview content · [ ] (d) preview UI panel · [ ] (e) reprint affordance · [ ] (f) persistent printer-failure banner · [ ] (g) persistent drawer-failure banner
