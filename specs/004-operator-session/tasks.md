...
**Created:** 2026-05-05
**Last updated:** 2026-05-11 — S4 implementation PRs through #103 merged. T052–T055, T063–T071 (incl. T069a/b/c, T070a/b), T074–T077 complete. PR #103 (T074–T077 PinPad + TakeoverPrompt UI) merged 2026-05-09; PR #105 (dev bootstrap stabilisation — CSP + preload Vite bundle) merged 2026-05-09. **Issue 85 decision recorded 2026-05-11:** cashier-path AD-2 local-only is a permanent architectural invariant (see `coordination.md` §"Issue 85 decision"); issue 85 closed. #86 remains open (owner-discretion closure); #101 open (terminal-A passive-polling gap); #87 open (S4 closeout). Remaining S4 implementation: T072, T073, T078–T082 (cashier-management surface, PIN reset/unlock, stuck-shift badge, route-guard, redaction log sites). S3 complete; all Phase 5 tasks (T039–T051d) marked ✅. S3 merged via PRs #49–#56 (HEAD `ba32133`).
